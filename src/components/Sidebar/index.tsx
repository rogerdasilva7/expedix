...
function sidebarCollapsed(){
    ...
    return(
        <div>
            <main className={`${!isCollapsed ? "w-64" : "w-20"} h-screen bg-[#020817] flex flex-col border-solid border-r-1 border-gray-100/20 transition-all ease-in-out duration-300`}
            onMouseEnter={() => {
